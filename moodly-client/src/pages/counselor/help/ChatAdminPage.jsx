...
// --- Daftar FAQ Khusus Counselor/Mitra ---
const faqsList = [
    "Cara atur jadwal?",
    "Kapan gaji cair?",
    "Pasien tidak hadir?",
...
export default function CounselorChatAdminPage() {
    ...
    useEffect(() => {
        ...
        console.log(`CounselorHelpChat: Mendengarkan ${channelName}`);
                            ...
                            <div className="flex justify-center mt-10">
                                <div className="bg-white px-6 py-4 rounded-2xl shadow-sm text-center border border-gray-100 max-w-[80%]">
                                    <p className="text-sm text-gray-600">
                                        Halo, Mitra Moodly! 👋 <br />
                                        Ada kendala jadwal, pencairan gaji, atau
                                        isu teknis? Tim Support siap membantu
                                        Anda.
                                    </p>
                                </div>
                            </div>
