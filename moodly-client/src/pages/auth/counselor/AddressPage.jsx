...
export default function CounselorAddressPage() {
    const navigate = useNavigate();
    const location = useLocation();

    // Ambil data yang dikirim dari CounselorRegisterPage
    ...
    useEffect(() => {
        // Jika tidak ada data awal (dibuka langsung), kembali ke registrasi konselor
        if (!currentData) {
    ...
    const handleSubmit = (e) => {
        ...
        // 2. Siapkan data untuk dikirim KEMBALI ke CounselorRegisterPage
        const dataToReturn = {
            ...currentData, // Data dari halaman 1 (nama, email, izin praktik, dll)
            address: newAddressData, // Data alamat baru
        };

        // 3. Navigasi KEMBALI ke /counselor/register sambil membawa semua data
        navigate("/counselor/register", {
        ...
        <>
            ...
            <main className="flex-grow flex flex-col p-8 pt-6">
                <p className="text-sm text-gray-500 mb-6">
                    Silahkan masukan alamat domisili Anda.
                </p>
