...
export default function RejectModal({
    ...
    const [reason, setReason] = useState(""); // State alasan wajib
    ...
    const handleConfirm = async () => {
        ...
        setLoading(true);
        try {
            // Memanggil fungsi handleReject dari parent dengan alasan
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md relative z-10 overflow-hidden transform transition-all scale-100">
                ...
                <div className="p-8 text-center">
                    ...
                    <p className="text-gray-500 mb-6 leading-relaxed text-sm">
                        Anda akan menolak pendaftaran customer <br />
                    ...
                    <div className="text-left mb-6">
                        ...
                        <textarea
                            ...
                            placeholder="Contoh: Data tidak valid, Foto KTP buram..."
                        ...
                        {!reason.trim() && (
                            <p className="text-xs text-gray-400 mt-1 ml-1 italic">
                                Wajib diisi agar customer tahu alasannya.
                            </p>
                        )}
                    </div>
