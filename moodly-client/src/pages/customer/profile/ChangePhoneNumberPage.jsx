...
import apiClient from "../../../api/axios.js"; // Path 3x mundur, dengan .js
import { useAuth } from "../../../context/AuthContext.jsx"; // <-- PERBAIKAN: Tambahkan .jsx
...
// --- PERBAIKAN: Hapus 'export default' dari sini ---
function ChangePhoneNumberPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await apiClient.post("/api/profile/change-phone", {
            ...
            setTimeout(() => {
                navigate("/profile/edit", { state: { phoneUpdated: true } });
            }, 1500);
        } catch (err) {
...
// --- PERBAIKAN: Tambahkan 'export default' di sini ---
